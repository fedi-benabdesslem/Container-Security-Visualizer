#!/usr/bin/env python3
# api/stats.py - Statistics endpoints
...
async def get_summary_stats(
    ...
    Returns overall statistics including total events, containers, and high-risk events.
    """
    try:
        ...
        # High-risk events (risk_score >= threshold)
...
async def get_timeline(
    ...
    Returns aggregated event counts over time intervals.
    """
    try:
        # Parse interval
        interval_map = {
